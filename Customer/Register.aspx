                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="pnlRegister" role="tabpanel">
                            <div class="mb-4">
                                ...
                                <asp:TextBox ID="txtFullName" runat="server" CssClass="form-control bg-dark border-secondary-light text-white py-3 rounded-3" placeholder="Enter your full name as on ID card"></asp:TextBox>
                            </div>
